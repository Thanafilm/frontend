                     ...
                     <div className='row  'style={{backgroundColor:"#F2F2F2", marginLeft:"10%",marginRight:"9.5%" , height: "900px"}}> 
                        ...
                        <div className="row " style={{ marginTop:"5px"}}>  
                                        ...
                                        <div class="container"style={{ marginLeft:"15px",marginTop:"20px"}}>
                                         <img src={acc1} alt="acc1"  style={{ height:"400px",width:"600px",marginLeft:"100px"}}></img>
                                        </div>

                                        <div className='row ' >
                                        <div className="col-md-3"><img src={acc1} alt="acc1" className="img4-box" style={{ height:"140px",width:"185px",marginLeft:"130px"}}></img></div>  
                                        <div className="col-md-3"><img src={acc1} alt="acc1" className="img5-box" style={{ height:"140px",width:"185px",marginLeft:"107px"}}></img></div>
                                        <div className="col-md-3"><img src={acc1} alt="acc1" className="img6-box" style={{ height:"140px",width:"185px",marginLeft:"86px"}}></img></div>   
